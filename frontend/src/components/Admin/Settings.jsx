                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">{formatTime(fridayMorningOpen.hour, fridayMorningOpen.minute)} PKT</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                          Morning Close
                        ...
                        <p className="text-xs text-gray-500 mt-1">{formatTime(fridayMorningClose.hour, fridayMorningClose.minute)} PKT</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1">{formatTime(fridayAfternoonOpen.hour, fridayAfternoonOpen.minute)} PKT</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                          Afternoon Close
                        ...
                        <p className="text-xs text-gray-500 mt-1">{formatTime(fridayAfternoonClose.hour, fridayAfternoonClose.minute)} PKT</p>
                      </div>
                    </div>
                  </div>
