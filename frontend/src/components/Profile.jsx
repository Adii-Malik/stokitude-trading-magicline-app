      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 border-b border-gray-200 dark:border-gray-700">
          <nav className="flex gap-4">
            <button
              ...
              className={`pb-4 px-2 font-medium transition border-b-2 ${activeTab === 'profile'
            ...
            <button
              ...
              className={`pb-4 px-2 font-medium transition border-b-2 ${activeTab === 'notifications'
                ? 'text-cyan-600 dark:text-cyan-400 border-cyan-600 dark:border-cyan-400'
                : 'text-gray-500 dark:text-gray-400 border-transparent hover:text-gray-700 dark:hover:text-gray-300'
                }`}
            >
        ...
        {activeTab === 'profile' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {/* Account Info */}
            <div className="mt-6 lg:mt-0 lg:col-span-2 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
