  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-ink">Strategy Manager</h2>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-cyan-600 text-white rounded-control hover:bg-cyan-700 transition-colors"
        >
      ...
      {/* Strategies Grid */}
      {strategies.length === 0 ? (
        <div className="bg-surface rounded-control shadow-card-hover p-12 text-center">
          ...
          <button
            onClick={openCreateModal}
            className="px-6 py-3 bg-cyan-600 text-white rounded-control hover:bg-cyan-700 transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {strategies.map((strategy) => (
            <div
              key={strategy._id}
              className="bg-surface rounded-control shadow-card-hover p-6 hover:shadow-dialog transition-shadow"
            >
              ...
              <div className="space-y-2 mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-control border border-blue-200 dark:border-blue-800">
              ...
              {strategy.performance && (
                <div className="grid grid-cols-2 gap-3 mb-4 p-3 bg-surface-muted rounded-control">
                  <div>
                  ...
                  <div>
                    <p className="text-xs text-ink-muted">Return</p>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-control transition-colors ${strategy.isActive
                ...
                <button
                  ...
                  className="px-4 py-2 flex items-center gap-2 text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-control transition-colors"
                >
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-surface rounded-control shadow-dialog max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreate} className="p-6 space-y-5">
              ...
              <div className="bg-cyan-50 dark:bg-cyan-900/20 p-4 rounded-control border-2 border-cyan-200 dark:border-cyan-800">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border-2 border-cyan-300 dark:border-cyan-700 rounded-control focus:ring-2 focus:ring-cyan-500 dark:bg-gray-700 dark:text-white font-medium"
                  required
                >
              ...
              {formData.pythonStrategy && (
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-control border-2 border-green-200 dark:border-green-800">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {['daily', 'weekly', 'monthly'].map((tf) => (
                      <button
                        ...
                        className={`px-4 py-3 rounded-control font-medium transition-all ${formData.pythonConfig?.timeframe === tf
                          ? 'bg-green-600 text-white shadow-card-hover scale-105'
                          : 'bg-surface text-ink-muted border-2 border-hairline hover:border-green-400'
                          }`}
                      >
              ...
              {formData.pythonStrategy && formData.pythonConfig?.timeframe && (
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-control border border-blue-200 dark:border-blue-800">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 font-medium text-lg border border-blue-300 dark:border-blue-700 rounded-control focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                  />
              ...
              {formData.pythonStrategy && formData.pythonConfig?.timeframe && Object.keys(slPresets).length > 0 && (
                <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-control border-2 border-orange-200 dark:border-orange-800">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-control font-medium transition-all text-left ${formData.slPreset === null
                        ? 'bg-orange-600 text-white shadow-card-hover scale-105 border-2 border-orange-700'
                        : 'bg-surface text-ink-muted border-2 border-hairline hover:border-orange-400'
                        }`}
                    >
                      ...
                      <p className={`text-xs ${formData.slPreset === null ? 'text-white/90' : 'text-ink-muted'}`}>
                        No SL applied
                      </p>
                    </button>
                    ...
                    {Object.entries(slPresets).map(([presetName, presetConfig]) => {
                      ...
                      return (
                        <button
                          ...
                          className={`p-3 rounded-control font-medium transition-all text-left ${formData.slPreset === presetName
                            ? 'bg-orange-600 text-white shadow-card-hover scale-105 border-2 border-orange-700'
                            : 'bg-surface text-ink-muted border-2 border-hairline hover:border-orange-400'
                            }`}
                        >
                          ...
                          <p className={`text-xs ${formData.slPreset === presetName ? 'text-white/90' : 'text-ink-muted'}`}>
                            {desc}
                          </p>
                        </button>
                      );
              ...
              {showSlConfig && slConfig && (
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-control border border-yellow-200 dark:border-yellow-800">
                  ...
                  <div className="space-y-3 max-h-64 overflow-y-auto">
                    {Object.entries(slConfig)
                      ...
                      .map(([key, value]) => {
                        ...
                        return (
                          <div key={key} className="bg-surface p-3 rounded border border-yellow-200 dark:border-yellow-700">
                            ...
                            {isBoolean ? (
                              <input
                                ...
                                className="w-4 h-4 text-orange-600 border-hairline rounded focus:ring-orange-500"
                              />
                            ) : isNumeric ? (
                              <input
                                type="number"
                                ...
                                className="w-full px-3 py-2 text-sm border border-hairline rounded-control focus:ring-2 focus:ring-orange-500 dark:bg-gray-600 dark:text-white"
                              />
                            ) : isString ? (
                              <input
                                type="text"
              ...
              {formData.pythonStrategy && getSelectedStrategyMetadata()?.metadata?.parameters && (
                <div className="border-t border-hairline pt-4">
                  <button
                    ...
                    className="flex items-center justify-between w-full text-sm font-medium text-ink-muted hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors"
                  >
                  ...
                  {showAdvancedParams && (
                    <div className="mt-3 space-y-3 p-4 bg-surface-muted rounded-control max-h-96 overflow-y-auto">
                      ...
                      {Object.entries(getSelectedStrategyMetadata().metadata.parameters)
                        ...
                        .map(([key, defaultValue]) => {
                          ...
                          return (
                            <div key={key} className="bg-surface p-3 rounded border border-hairline">
                              <div className="flex justify-between items-center mb-2">
                                <label className="text-xs font-semibold text-ink-muted">
                                  {key.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}
                                </label>
                              ...
                              {isNumeric ? (
                                <input
                                  ...
                                  className="w-full px-3 py-2 text-sm border border-hairline rounded-control focus:ring-2 focus:ring-cyan-500 dark:bg-gray-600 dark:text-white"
                                />
                              ) : isString ? (
                                <input
                                  type="text"
                                ...
                                <input
                                  ...
                                  className="w-full px-3 py-2 text-sm font-mono border border-hairline rounded-control focus:ring-2 focus:ring-cyan-500 dark:bg-gray-600 dark:text-white"
                                />
                              )}
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="isActive" className="text-sm text-ink-muted">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-hairline text-ink-muted rounded-control hover:bg-hairline dark:hover:bg-gray-700 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-cyan-600 text-white rounded-control hover:bg-cyan-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
